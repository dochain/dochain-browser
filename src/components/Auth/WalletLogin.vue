      ...
      <div class="appWrapper">
        ...
        <div class="formContainer">
          <form name="loginForm" class="form ng-pristine ng-invalid ng-invalid-required" @submit.prevent="login()">
            ...
            <div class="form-group form-group-lg" :class="{'has-error': (errors.has('wallet_id')) }">
              <label class="control-label ng-binding">钱包ID</label>
              <input
                @focus="hideAlert"
                data-vv-as="钱包ID"
                name="wallet_id"
                ...
                type="text"
                placeholder="钱包ID"
                v-model="data.wallet_id"
              >
              <div class="help-block ng-scope" v-show="errors.has('wallet_id')">
                  <div class="ng-binding ng-scope">{{ errors.first('wallet_id') }}</div>
              </div>
            </div>
